...
const projects = [
  ...
  { name: "Bar RR", esType: "Remodelación music bar · Comercial", enType: "Music bar remodel · Commercial", es: "Un music bar con carácter — madera cálida, piano de cola e iluminación en capas.", en: "A music bar with character — warm wood, a grand piano and layered light.", images: ["IMG_5512.jpeg", "IMG_5513.jpeg"] },
];
